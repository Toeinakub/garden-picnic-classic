      ...
      <div className="drawer-sheet" onClick={e => e.stopPropagation()}>
        ...
        {items.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '40px 10px', color: '#aba28c' }}>
            <p style={{ fontSize: '14px', marginBottom: '8px' }}>ยังไม่มีผลไม้ในตะกร้า</p>
          ...
          <>
              ...
              {items.map(item => (
                <div key={item.fruit.id} className="drawer-item-row">
                  <div className="item-thumb-name">
                    ...
                    />
                    <div>
                      <h4 style={{ fontSize: '13.5px', color: '#f8f5ee', fontWeight: 600 }}>
                        {item.fruit.thaiName}
                      </h4>
            ...
            <div style={{ borderTop: '1px solid rgba(212, 175, 55, 0.2)', paddingTop: '12px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px', fontSize: '12.5px', color: '#aba28c' }}>
                <span>กล่องและแพ็กเกจจิ้งสานพรีเมียม</span>
                <span style={{ color: '#d4af37' }}>ฟรี (Complimentary)</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: '14px' }}>
                <span style={{ fontSize: '15px', fontWeight: 600 }}>ยอดรวมสุทธิ</span>
